...
public class WordGuessServer extends UnicastRemoteObject implements WordGuessService {
    ...
    public String guessLetter(char letter) throws RemoteException {
        ...
        if (letrasUsadas.contains(String.valueOf(letter))) {
            ...
            if (isGameOver()) {
                if (hasWon()) {
                	gameOver();
                	return "Você venceu! A palavra era '" + palavraChave + "'";
                }
                
                else {
                    return "Fim de jogo... A palavra era '" + palavraChave + "'";
                 
                }
            } else {
                return "Palavra: " + getWordWithGuesses() + "\nVoc� tem " + vidas + " vidas restantes.";
            }
        }
    } 
    ...
    private String getWordWithGuesses() {
    	...
    	if(hasWon() == true) {
        String mensagem = "Fim de jogo... A palavra era '" + palavraChave + "'";
